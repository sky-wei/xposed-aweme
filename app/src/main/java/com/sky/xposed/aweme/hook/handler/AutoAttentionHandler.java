...
public class AutoAttentionHandler extends CommonHandler {
    ...
    public AutoAttentionHandler(HookManager hookManager) {
        super(hookManager);
    }
    ...
    public void onHandler() throws Exception {
        ...
        // 关注
        mainPerformClick(curView, mVersionConfig.idAttentionLayout);
    }
    ...
    public void attention(int position) {
        ...
        // 开始点赞
        mHandler.postDelayed(this, RandomUtil.random(3000, 3500));
    }
